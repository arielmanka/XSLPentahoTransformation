XSL transformation for Pentaho Spoon transformation files (.ktr) This set of files allows you to create html documenation of Pentaho transformation using XSL and simple css
