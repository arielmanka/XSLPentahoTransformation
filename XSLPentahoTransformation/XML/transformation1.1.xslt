<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="transformation">
        <html>
            ...
            <body>
                ...
                <br/>
                <xsl:apply-templates select="step/type[text() = 'CMDBInput']"/>
                <br/>
                <xsl:apply-templates select="step/type[text() = 'DBLookup']"/>
                <br/>
                <xsl:apply-templates select="step/type[text() = 'DetectLastRow']"/>
                <br/>
                <xsl:apply-templates select="step/type[text() = 'SetValueField']"/>
                <br/>
            </body>
        </html>
    </xsl:template>
    ...
    <xsl:template match="step/type[text() = 'CMDBInput']">
        <div class="datagrid">
            <table>
                <caption>
                    <xsl:value-of select="."/>
                ...
                <tr>
                    <th>Class Namr</th>
                    <td>
                        <xsl:value-of select="../lookup/table"/>
                    </td>
                </tr>
                <tr>
                    <th>NameSpace</th>
                ...
                <tr>
                    ...
                    <td>
                        <xsl:value-of select="../lookup/selectedAttributeNames"/>
                    </td>
                </tr>
                <tr>
                    <th>Selected Qualification</th>
                    <td>
                        <xsl:value-of select="../lookup/qualificationString"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <xsl:template match="step/type[text() = 'DBLookup']">
        <div class="datagrid">
            <table>
                <caption>
                    <xsl:value-of select="."/>
                ...
                <tr>
                    <th>Lookup Schema</th>
                    <td>
                        <xsl:value-of select="../lookup/schema"/>
                    </td>
                </tr>
                <tr>
                    <th>Lookup Table</th>
                ...
                <tr>
                    <th>Cache size in rows</th>
                    <td>
                        <xsl:value-of select="../cache_size"/>
                    </td>
                </tr>
                <tr>
                    <th>Load all data from table</th>
                    <td>
                        <xsl:value-of select="../cache_load_all"/>
                    </td>
                </tr>
                <tr>
                    <th> The Keys to Lookp up the values </th>
                    <td>
                        <table>
                            <tr>
                                <th>Table Field</th>
    ...
    <xsl:template match="step/type[text() = 'DetectLastRow']">
        <div class="datagrid">
            <table>
                <caption>
                    <xsl:value-of select="."/>
                ...
                <tr>
                    <th>Result Field Name</th>
                    <td>
                        <xsl:value-of select="../resultfieldname"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <xsl:template match="step/type[text() = 'SetValueField']">
        <div class="datagrid">
            <table>
                <caption>
                    <xsl:value-of select="."/>
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <th>Field Name</th>
                                <th>Replace by value from field</th>
                            </tr>
                            <xsl:for-each select="../fields/field">
                                <tr>
                                    <td>
